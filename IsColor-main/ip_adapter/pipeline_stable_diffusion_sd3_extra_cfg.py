...
class StableDiffusion3PipelineExtraCFG(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    r"""
    Args:
    ...
    def __call__(
        ...
        instruct_guidance_scale: float = 7.0,
        ...
        if self.do_classifier_free_guidance:
            ...
            if simple_cfg_mode == True:
                ...
                pooled_prompt_embeds = torch.cat([pooled_prompt_embeds, negative_pooled_prompt_embeds], dim=0)
            else:
                prompt_embeds = torch.cat([prompt_embeds,img_only_prompt_embeds,img_prompt_everything_cond, negative_prompt_embeds], dim=0)
                pooled_prompt_embeds = torch.cat([pooled_prompt_embeds,pooled_prompt_embeds,pooled_prompt_embeds, negative_pooled_prompt_embeds], dim=0)
