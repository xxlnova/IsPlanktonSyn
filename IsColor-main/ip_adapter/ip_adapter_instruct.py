        ...
        **kwargs,
        ...
        with torch.inference_mode():
            ...
            image_prompt_embeds, uncond_image_prompt_embeds,img_only_prompt_embeds,img_prompt_everything_cond = self.get_image_embeds(
                ...
                prompt_embeds=small_prompt_embeds,
                negative_prompt_embeds=small_negative_prompt_embeds,
        ...
        generator = torch.Generator(self.device).manual_seed(seed) if seed is not None else None
        images = self.pipe(
            prompt_embeds=prompt_embeds,                   # [2,93,2048]
            negative_prompt_embeds=negative_prompt_embeds, # [2,93,2048]
            guidance_scale=guidance_scale,
            pooled_prompt_embeds=pooled_prompt_embeds,     # [2,1280]
            img_only_prompt_embeds=img_only_prompt_embeds, # [2,93,2048]
            img_prompt_everything_cond=img_prompt_everything_cond, # [2,93,2048]
            negative_pooled_prompt_embeds=negative_pooled_prompt_embeds, # [2,1280]
            num_inference_steps=num_inference_steps,
            image_guidance_scale=image_guidance_scale,
            instruct_guidance_scale=instruct_guidance_scale,
            generator=generator,
