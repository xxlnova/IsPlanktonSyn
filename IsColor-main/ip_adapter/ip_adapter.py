...
class IPAdapter:
    ...
    def set_ip_adapter(self,dtype=torch.float16):
        unet = self.pipe.unet
        attn_procs = {}
    ...
    def load_ip_adapter(self):
        ...
        ip_adapter_keys = state_dict["ip_adapter"].keys()
        print("ip_adapter keys =", ip_adapter_keys)
        ip_layers.load_state_dict(state_dict["ip_adapter"])

    def get_image_embeds(self, pil_image=None, clip_image_embeds=None,dtype=torch.float32):
